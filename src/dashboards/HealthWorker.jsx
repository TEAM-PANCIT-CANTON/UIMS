...
const navItems = [
  { name: 'Dashboard', key: 'dashboard', icon: Activity }, // Added Dashboard tab
...
const HealthWorker = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#B3DEF8] to-[#58A1D3]">
      {/* Dashboard Header - Integrated into layout or kept minimal */}
      <header className="bg-white shadow-lg py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="ml-4 bg-[#06172E] text-white px-4 py-2 rounded-lg hover:bg-opacity-90 transition-colors duration-200 flex items-center space-x-1">
              <LogOut size={16} />
        ...
        {/* Navigation Tabs */}
        <nav className="bg-white border-t border-gray-200 mt-4">
